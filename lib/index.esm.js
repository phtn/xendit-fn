...
const IndividualDetailSchema$1 = z.object({
    given_names: z.string(),
    surname: z.string().optional(),
...
const ChannelPropertiesSchema$2 = z.discriminatedUnion("channel_code", [
    z.object({
...
// Capture Method
const CaptureMethodSchema$1 = z.union([
    z.literal("AUTOMATIC"),
    z.literal("MANUAL")
]);
...
// Channel Properties
const ChannelPropertiesSchema$1 = z.object({
...
const AllowSavePaymentMethodSchema = z.union([
    z.literal("DISABLED"),
    z.literal("OPTIONAL"),
    z.literal("FORCED")
]);
// Session Mode
const SessionModeSchema = z.union([
...
// Customer Details
const PaymentSessionCustomerDetailsSchema = z.object({
    type: z.literal("INDIVIDUAL"),
...
// Item Schema
const PaymentSessionItemSchema = z.object({
    reference_id: z.string().min(1).max(255),
...
// Channel Properties
const ChannelPropertiesSchema = z.object({
    allowed_payment_channels: z.array(z.string()).optional()
});
// Metadata
const MerchantMetadataSchema = z.record(z.string().max(40), z.string().max(500)).refine((obj)=>Object.keys(obj).length <= 50, "Metadata can have at most 50 keys").nullable().optional();
